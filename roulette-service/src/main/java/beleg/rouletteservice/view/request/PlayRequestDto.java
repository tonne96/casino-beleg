...
public record PlayRequestDto(
        ...
        @Schema(description = """
                ...
                - SINGLE: [zahl] - genau eine Zahl, 0 bis 36
                ...
                - STREET: [a] - Start einer 3er-Reihe, a aus {1,4,7,...,34}
                - SIX_LINE: [a] - Start einer 6er-Reihe, a aus {1,4,7,...,31}
                - CORNER: [a] - linke obere Ecke eines Vierecks, a 1-32, a modulo 3 ungleich 0
                - SPLIT: [a, b] - zwei auf dem Tableau echt benachbarte Zahlen, je 1-36
